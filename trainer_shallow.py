...
class Trainer(object):
    ...
    def train_model(self, epoch, bs):
        ...
        train_data = shallowDataset(img_dir=self.train_dir,
                                    target=pd.read_csv(r"F:\DigitalAG\morocco\unet\baseline\\32\training\label.csv", index_col=0))
        ...
        vali_data = shallowDataset(img_dir=self.vali_dir,
                               target=pd.read_csv(r"F:\DigitalAG\morocco\unet\baseline\\32\validation\label.csv", index_col=0))
